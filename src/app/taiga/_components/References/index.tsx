...
import references from '@/data/biomes/taiga/references'
      ...
      <div className="container mx-auto px-5 md:px-15 lg:px-30">
        <div className="text-center mb-12">
          ...
          <p className={`text-xl ${styles.textcolor} max-w-3xl mx-auto mb-8`}>
            ...
            sobre a taiga e as espécies que habitam este fascinante bioma.
          </p>
          ...
          <div className="max-w-md mx-auto mb-12 relative">
            <div className="relative">
              <input
                ...
                className={`${styles.inputcolor} w-full py-3 px-5 pl-12 rounded-full border text-white placeholder-emerald-300 focus:outline-none focus:ring-2 transition-all duration-300`}
              />
              <FaSearch
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {filteredReferences.map((reference: Reference, index: number) => (
            <div
              key={index}
              className={`${styles.cardcolor} backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border  transition-all duration-300 transform hover:-translate-y-1`}
        ...
        >
          <h3 className={`text-xl font-semibold ${styles.textcolor} mb-3 flex items-center`}>
          ...
          <p className={`${styles.notetextcolor}`}>
            ...
            informações precisas e atualizadas sobre a taiga e suas espécies.
