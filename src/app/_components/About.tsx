...
export default function About() {
  return (
    <div id="about" className="bg-blue-950 text-white py-20">
      <div className="mx-10 md:mx-30">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-20">
          ...
          <div className="flex flex-col gap-10">
            <h3 className="text-3xl">Nossa História</h3>
            <p className="text-2xl">
        ...
        <div className="mt-20">
          <h3 className="text-3xl">Nossa Equipe</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
            <TeamCard name='Antonio Marcos' role='Fundador e Diretor Geral' image='/marcos.jpg' />
            <TeamCard name='Ariel Gadelha' role='Coordenador de Projetos' image='/ariel.jpg' />
            <TeamCard name='Gabriel Lima' role='Biólogo & Pesquisador' image='/gabriel.jpg' />
            <TeamCard name='Marcos Eduardo' role='Designer & Criador de Conteúdo' image='/dudu.jpg' />
            <TeamCard name='Pedro Lucas' role='Especialista em Captação de Recursos' image='/pedro.jpg' />
            <TeamCard name='Wenderson Inácio' role='Gestor de Comunicação & Parcerias' image='/wenderson.jpg' />
            </div>
        </div>
      </div>
    </div>
